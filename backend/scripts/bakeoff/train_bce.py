#!/usr/bin/env python3
"""Bakeoff: BCE MLP (pointwise supervised / multi-label).

Category: pointwise_supervised

Usage (from repo root):

  python backend/scripts/bakeoff/train_bce.py
"""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Bakeoff train: BCE MLP (pointwise).")
    ...
    def train_fn() -> None:
        ...
        for epoch in range(1, args.epochs + 1):
            ...
            print(
                f"epoch {epoch:03d}  train_bce={train_loss:.4f}  "
